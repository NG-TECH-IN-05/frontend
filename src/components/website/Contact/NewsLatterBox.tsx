const NewsLatterBox = () => {
  // const theme = useAppSelector((state) => ta);
  return (
    <div className='shadow-three relative z-10 h-full rounded-sm bg-white p-8 dark:bg-slate-700 dark:bg-blend-darken sm:p-11 lg:p-8 xl:p-11'>
      ...
      <div>
        <input
          ...
          className='border-stroke text-body-color dark:text-body-color-dark dark:shadow-two mb-4 w-full rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base outline-none focus:border-primary dark:border-transparent dark:bg-[#2C303B] dark:focus:border-primary dark:focus:shadow-none'
        />
        <input
          type='email'
          name='email'
        ...
        <input
          type='submit'
          value='Souscrire'
          className='shadow-submit dark:shadow-submit-dark hover:bg-primary/90 mb-5 flex w-full cursor-pointer items-center justify-center rounded-sm bg-primary px-9 py-4 text-base font-medium text-white duration-300'
        />
