...
export default function Nav({
  ...
  return (
    <div
      ...
      className={cn(
        'group border-b bg-slate-900 py-2  text-white transition-[max-height,padding] duration-500 data-[collapsed=true]:py-2 md:border-none',
        className
      )}
    >
...
function NavLink({
  ...
  return (
    <Link
      ...
      className={cn(
        buttonVariants({
          variant: checkActiveNav(href) ? 'blue' : 'ghost2',
          size: 'sm',
        }),
      ...
      <Tooltip delayDuration={0}>
        <TooltipTrigger asChild>
          <DropdownMenuTrigger asChild>
            <Button
              variant={isChildActive ? 'blue' : 'ghost2'}
              size='icon'
              className='h-12 w-12'
            >
              {icon}
